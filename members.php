	...
	<div class="container">
			<div class="row">
					<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
						...
						<?php
						//Post preview.
							$sql_members = "SELECT * FROM tbl_users";
							$query_members = $db->query($sql_members);
						?>
						<?php
							//post preiew
							require_once 'core/members_preview.php';
						?>
					</div>
			</div>
	</div>
