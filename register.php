...
if(isset($_POST['btn-signup'])) {
	...
	if ($count==0) {
		...
		$query = "INSERT INTO tbl_users(username,email,password,user_image) VALUES('$uname','$email','$hashed_password','$profile_picture')";
...
<div class="signin-form">
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form">
        ...
        <h2 class="form-signin-heading">Sign Up to MCA16</h2><hr />
